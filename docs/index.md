...
<div class="bsfm-card">
  ...
  <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
    ...
    <a href="recursos/roadmap.md" class="bsfm-btn bsfm-btn-secondary" style="padding: 0.5rem 1rem; font-size: 0.9rem;">Roadmap</a>
    <a href="recursos/changelog.md" class="bsfm-btn bsfm-btn-secondary" style="padding: 0.5rem 1rem; font-size: 0.9rem;">Changelog</a>
    <a href="recursos/casos-uso.md" class="bsfm-btn" style="padding: 0.5rem 1rem; font-size: 0.9rem;">Casos de Uso</a>
    <a href="recursos/glossario.md" class="bsfm-btn bsfm-btn-secondary" style="padding: 0.5rem 1rem; font-size: 0.9rem;">Glossário</a>
  </div>
</div>
